...
print("3500K, 90CRI: %.4f" % (k_CREE_J2835_3500K_90CRI*10**6), "µmol/(Lm*s)")
...
print("3000K, 80CRI: %.4f" % (k_CREE_J2835_3000K_80CRI*10**6), "µmol/(Lm*s)")
print("3500K, 80CRI: %.4f" % (k_CREE_J2835_3500K_80CRI*10**6), "µmol/(Lm*s)")
...
print("4000K, 70CRI: %.4f" % (k_CREE_J2835_4000K_70CRI*10**6), "µmol/(Lm*s)")
print("5000K, 70CRI: %.4f" % (k_CREE_J2835_5000K_70CRI*10**6), "µmol/(Lm*s)")
print("5700K, 70CRI: %.4f" % (k_CREE_J2835_5700K_70CRI*10**6), "µmol/(Lm*s)")
print("6500K, 70CRI: %.4f" % (k_CREE_J2835_6500K_70CRI*10**6), "µmol/(Lm*s)")
